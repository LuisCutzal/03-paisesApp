...
export class PaisService {
  ...
  buscarPais(termino:string):Observable<Contry[]>{
    ...
    return this.http.get<Contry[]>(utl,{params:this.httpParams});
  }
  ...
  buscarIdPais(id:string):Observable<Contry>{
  ...
  buscarRegion(region:string):Observable<Contry[]>{
    ...
    este codigo funciona pero para hacerlo aun más sencillo se utilizo el get httpParams(){}
